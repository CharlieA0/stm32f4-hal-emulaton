...
HAL_StatusTypeDef HAL_I2C_Master_Transmit(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t *pData, uint16_t Size, uint32_t Timeout) {
  ...
  TEST_ASSERT_LESS_THAN_PTR_MESSAGE(tx_queue_start, tx_queue_end, "I2C Mock Failed: tx_queue's start is after its end");
...
// Always sets recieve_address to DevAddress before reading
